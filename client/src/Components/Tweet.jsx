...
function Tweet() {
  return (
    <div className="px-12 flex items-center justify-center">
      <div className="  dark:bg-gray-800 border-gray-200 dark:border-gray-800 p-4 rounded-xl border max-w-xl">
        ...
        <div className="text-gray-500 dark:text-gray-400 flex mt-3">
          <div className="flex w-full justify-between">
            ...
            <div className="flex gap-4 w-36 justify-center items-center  ">
              <div className="flex group gg items-center justify-center gap-3   transition-all delay-75 cursor-pointer rounded-md px-4 py-1">
                <FaRetweet
                  className="group-hover:text-green-400  transition-all delay-75  "
                  size={22}
                />
                <span className="group-hover:text-green-400  transition-all delay-75 ">
                  6,321
                </span>
              </div>{" "}
              <div className=" group transition-all delay-75 cursor-pointer rounded-md px-4 py-1">
                <GoShare size={22} />
              </div>{" "}
            </div>
          </div>
